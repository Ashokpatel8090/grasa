...
const HeroSection = () => {
  ...
  return (
    <section className="w-full px-4 sm:px-6 lg:px-8 pt-6 pb-16">
      <div className="w-[90%] md:w-[95%] mx-auto">

        {/* Hero Container */}
        <div className="relative rounded-2xl md:rounded-3xl overflow-hidden min-h-[400px] sm:min-h-[480px] md:min-h-[580px] lg:min-h-[660px] flex items-start pt-12 sm:pt-20 md:pt-28 lg:pt-40 px-6 sm:px-12 md:px-16 lg:px-24 shadow-2xl bg-gradient-to-br from-gray-900 to-black">
          ...
          <div className="relative z-10 max-w-2xl text-white">
            ...
            <div className="inline-block mb-6 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20">
              <span className="text-xs md:text-sm font-semibold uppercase tracking-wider">Transform Your Gut Health</span>
            </div>
            ...
            <p className="text-base md:text-lg text-gray-200 mb-8 max-w-lg leading-relaxed">
              Get a scientifically-backed assessment of your gut health and receive a personalized wellness plan.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-10">
              {!mounted ? (
                <button
                  className="bg-accent text-foreground font-bold px-8 py-4 rounded-lg text-base md:text-lg opacity-0 pointer-events-none uppercase tracking-wide shadow-lg"
                >
                  START YOUR TEST ™
                </button>
              ) : hasStoredResult ? (
                <>
                  <button
                    ...
                    className="bg-accent hover:bg-accent/90 text-foreground font-bold px-8 py-4 rounded-lg text-base md:text-lg uppercase tracking-wide shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    VIEW RESULT
                  </button>
                  <button
                    ...
                    className="bg-white/20 hover:bg-white/30 border border-white/40 text-white font-bold px-8 py-4 rounded-lg text-base md:text-lg uppercase tracking-wide hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg>
                    RETAKE TEST
                  </button>
                ...
                <button
                  ...
                  className="bg-accent hover:bg-accent/90 text-foreground font-bold px-8 py-4 rounded-lg text-base md:text-lg uppercase tracking-wide shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2 group"
                >
                  START YOUR TEST ™
                  <svg className="w-5 h-5 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                </button>
        ...
        {/* Floating Stats Cards */}
        <div className="relative z-20 -mt-8 sm:-mt-12 md:-mt-16 px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-5">

            {/* Card 1: 500+ */}
            <div className="bg-white p-4 sm:p-5 rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border border-gray-100 backdrop-blur-sm">
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  <div className="bg-accent/20 p-3 rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 sm:w-6 sm:h-6 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <p className="text-xs sm:text-sm text-gray-600 font-semibold uppercase tracking-wide">People Helped</p>
              </div>
            </div>
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  <div className="bg-green-100 p-3 rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 sm:w-6 sm:h-6 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                  </div>
                  <h3 className="text-xl sm:text-2xl font-bold text-foreground">87%</h3>
                </div>
                <p className="text-xs sm:text-sm text-gray-600 font-semibold uppercase tracking-wide">Feel Energetic</p>
              </div>
            </div>
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  <div className="bg-blue-100 p-3 rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                  </div>
                  <h3 className="text-xl sm:text-2xl font-bold text-foreground">FSSAI</h3>
                </div>
                <p className="text-xs sm:text-sm text-gray-600 font-semibold uppercase tracking-wide">Certified</p>
              </div>
            </div>
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  <div className="bg-yellow-100 p-3 rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-600" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                  </div>
                  <h3 className="text-xl sm:text-2xl font-bold text-foreground">4.8★</h3>
                </div>
                <p className="text-xs sm:text-sm text-gray-600 font-semibold uppercase tracking-wide">Rated</p>
              </div>
            </div>
