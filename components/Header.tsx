...
//         {/* Adjusted padding (px-6 md:px-8 lg:px-12) to be strictly equal on both sides */}
//         <div className="flex items-center justify-between max-w-7xl mx-auto px-6 md:px-8 lg:px-12 h-[72px]">
