...
//     `https://medicaps.cloud/millets/products/${id}`,
//     { cache: "no-store" }
//   );
...
//             <button className="bg-green-800 text-white px-8 py-3 rounded-lg hover:bg-green-900">
//               Add to Cart
//             </button>
...
//         const res = await fetch(`https://medicaps.cloud/millets/products/${resolvedParams.id}`);
...
//         {/* Information Section */}
//         <div className="space-y-3 text-[17px] mb-10 bg-white p-6 rounded-xl border">
//           <p><span className="font-bold">Ingredients:</span> {nutrition.Ingredients.join(", ")}</p>
//           <p><span className="font-bold">Storage:</span> {nutrition["Storage Instructions"].join(" ")}</p>
//           <p><span className="font-bold">Best Before:</span> {nutrition["Best Before"]}</p>
//           <p><span className="font-bold">Allergen Info:</span> {nutrition["Allergen Information"]}</p>
//           <p><span className="font-bold">FSSAI Reg No:</span> {nutrition["FSSAI Reg No"]}</p>
//         </div>
...
//             <h3 className="font-semibold text-lg mb-4 text-gray-500">Per 100g</h3>
//             <table className="w-full">
//               <tbody>
//                 {Object.entries(nutrition["Nutritional Facts"]["Per 100g"]).map(([key, value]) => (
//                   <tr key={key} className="border-t border-gray-100">
//                     <td className="py-2 font-medium text-gray-700">{key}</td>
//                     <td className="py-2 text-right font-bold text-green-900">{String(value)}</td>
//                   </tr>
//                 ))}
//               </tbody>
//             </table>
