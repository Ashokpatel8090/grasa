...
export default function LongevityResultPage() {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-5 border-t border-white/10">
                  ...
                  >
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-[#C5D82D] group-hover:text-black font-extrabold transition-transform duration-200 group-hover:translate-x-1">
      →
    </span>
                    </div>
  ...
  className="group inline-flex w-fit mx-auto py-3.5 px-15 bg-[#C5D82D] text-black font-sans font-bold text-[1rem] rounded-xl cursor-pointer transition-all duration-200 items-center justify-center gap-3 hover:bg-[#d9ed3d] hover:text-black hover:-translate-y-[2px] hover:shadow-[0_0_20px_rgba(197,216,45,0.45)]"
>
  <svg
    viewBox="0 0 24 24"
    width="20"
  ...
  <span className="text-black font-extrabold transition-transform duration-200 group-hover:translate-x-2">
    →
  </span>
</button>
              </div>
            ...
            <div className="animate-fadeUp mt-10">
              ...
              <div className="bg-white/5 border-[1.5px] border-white/10 backdrop-blur-sm rounded-2xl p-8 text-center mb-4">
                ...
                <div className="flex flex-col gap-3 max-w-sm mx-auto">
                  ...
                  <button
  onClick={() => router.push("/consultations")}
  className="py-3.5 px-6 bg-white/5 border border-white/10 text-white font-sans font-bold text-[1rem] rounded-xl cursor-pointer transition-all duration-200 flex items-center justify-center gap-3 hover:bg-white hover:text-black hover:-translate-y-[2px]"
>
  <svg
    viewBox="0 0 24 24"
    width="20"
