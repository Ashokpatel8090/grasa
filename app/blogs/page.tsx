...
//       <h1 className="text-4xl font-bold mb-8 text-gray-900 text-center">GRASA Wellness Journal</h1>
//       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
//         {blogs.map((blog) => (
//           <article key={blog.slug} className="border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
//             <img 
//               src={blog.image} 
//               alt={blog.title} 
...
//             />
//             <div className="p-6">
//               <span className="text-sm font-semibold text-emerald-600 uppercase tracking-wider">{blog.category}</span>
//               <h2 className="text-xl font-bold mt-2 mb-3 leading-tight">
...
//                 <span>{blog.date}</span>
//                 <Link href={`/blogs/${blog.slug}`} className="font-bold text-gray-900 hover:underline">
//                   READ MORE
//                 </Link>
//               </div>
//             </div>
