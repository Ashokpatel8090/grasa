...
export default function Signup() {
  ...
  if (subscription) {
    ...
    setCookie("subscription_expiry", subscription.current_period_end ?? "");
    setCookie(
...
handleLoginSuccess(
  ...
  data.grasa_subscription // ✅ IMPORTANT
);
  ...
  const handleGoogleFormSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      await axios.post(`${BASE_URL}/api/users/google-login`, {
        gid_token: gidToken,
        phone: formData.phone,
        role_id: 1,
        referral_code: formData.referral_code || "",
      ...
      const loginRes = await axios.post(`${BASE_URL}/api/users/google-login`, {
        gid_token: gidToken,
      });
